...
dataset = sys.argv[1]
if dataset == "opp":
    path = os.path.join(os.path.expanduser('~'), 'Documents', 'pythonProject', 'teachter model training with OpportunityUCID', 'opportunity.h5')
elif dataset =="dap":
...
train, test = train.align(test, join='inner', axis=1) # maybe 'outer' is better inner
...
with tf.Session() as session:
    ...
    saver.save(session, "./model/teacher.ckpt")
